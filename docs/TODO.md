...
- **T-241** : T-200 follow-up — Persister la déclaration sur l'honneur en base (timestamp + snapshot des 4 valeurs déclarées + version du wording certifié) pour traçabilité DGCCRF. Aujourd'hui c'est validé via Zod mais non persisté. Avant ouverture publique.
