...
> Session `/plan-ceo-review` 2026-05-12. PR #121 (branche `feature/p1-regression-sweep-axes-1-5`). 9 commits atomiques, 5 axes structurés.
>
...
>
> 🟢 **CI workflow** : `.github/workflows/test-sql-integration.yml` — Supabase CLI v2.92.1 + Docker + Node 20 LTS. Premier run vert en 2m40s. Step validation explicite des keys avant tests pour éviter fallback hardcoded silencieux.
>
...
> - `04ae538` fix(test): normalize EOL in codegen-enums parity check (Windows drift)
...
> - `d2b1bf2` docs(claude-md): pattern E2E sentinel + cleanup + cross-ref doctrine
