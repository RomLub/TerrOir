// Cluster B Phase 3 (bugs-P1-3) — config Sentry edge runtime (middleware,
// edge route handlers). TerrOir n'utilise pas l'edge runtime pour les
// routes critiques refund/cron, mais le middleware s'execute en edge ;
// on init pour completude.
